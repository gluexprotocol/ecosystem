  ...
  return (
    <div className="relative flex-grow backdrop-blur-md w-full sm:max-w-md">
      ...
      <input
        ...
        placeholder="Search..."
        className={`bg-zinc-800/30 py-2 pr-4 pl-12 border focus:border-zinc-800 border-transparent rounded-lg focus:outline-none w-full text-white/75 focus:text-white transition-colors duration-300 placeholder-white/60 ${
          searchTerm
